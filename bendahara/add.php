...
<div id="sectionHeader">Data Bendahara > Tambah</div>
<table border="0" cellpadding="1" cellspacing="0" id="b2">
	...
	<tr>
		<td>
		<form name="frm" method="post" action="bendahara/qadd.php" onSubmit="return checkForm(this)" enctype="multipart/form-data">
		<table border="0" cellpadding="2" cellspacing="0" width="100%">
            <tr>
				<td width="150">Bendahara* </td>
				<td>:</td>
				<td><input type="text" name="txtBendahara" id="TxtKet" size="70"/>
                </td>
			</tr>
			<tr>
				<td>&nbsp;</td>
